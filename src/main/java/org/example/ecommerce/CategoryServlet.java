            ...
            if (name != null && description != null && categoryId == null) {
                ...
                try (Connection connection = dataSource.getConnection()) {
                    ...
                    try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                        ...
                        if (effectedRows > 0) {
                            resp.sendRedirect("adminCategory.jsp?message=Category added");
                        } else {
                            resp.sendRedirect("adminCategory.jsp?error=Category not added");
                        }
                    }
                ...
                try (Connection connection = dataSource.getConnection()) {
                    ...
                    try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                        ...
                        int effectedRows = preparedStatement.executeUpdate();
                        if (effectedRows > 0) {
                            resp.sendRedirect("adminCategory.jsp?message=Category deleted");
                        } else {
                            resp.sendRedirect("adminCategory.jsp?error=Category not deleted");
                        }
                    }
                } catch (SQLException e) {
                    e.printStackTrace();
                ...
                try (Connection connection = dataSource.getConnection()) {
                    ...
                    try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                        ...
                        int effectedRows = preparedStatement.executeUpdate();
                        if (effectedRows > 0) {
                            resp.sendRedirect("adminCategory.jsp?message=Category updated");
                        } else {
                            resp.sendRedirect("adminCategory.jsp?error=Category not updated");
                        }
                    }
                } catch (SQLException e) {
                    e.printStackTrace();
                ...
                resp.sendRedirect("adminCategory.jsp?error=Invalid request");
            }
        }
    }
